...
export function Home(props){
    ...
    const evaluateBubble = (keyword, index) => {
        ...
        if(keyword !== undefined && index !== undefined){
            ...
            else if(keywords[index-3] === undefined && [undefined, 'sudo'].includes(keywords[index-2]) && ['pacman', 'yay', 'paru'].includes(keywords[index-1]) && ['-R', '-Rs', '-Rns', '-Rsc', '-Rdd'].includes(keyword)) return `Comando para desinstalar paquetes con ${keywords[index-1]};Comando`
            else if(keywords[index-4] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && ['pacman', 'yay', 'paru'].includes(keywords[index-2]) && keywords[index-1]==='-S') return 'Nombre de paquete;Paquete'
            else if(keywords[index-4] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && packagemanagers.filter(p=>p!=='pacman'&&p!=='yay'&&p!=='paru').includes(keywords[index-2]) && keywords[index-1]==='install') return `Nombre de paquete;Paquete`
            else if(keywords[index-4] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && packagemanagers.filter(p=>p!=='pacman'&&p!=='yay'&&p!=='paru').includes(keywords[index-2]) && keywords[index-1]==='remove') return `Nombre de paquete;Paquete`
            else if(keywords[index-4] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && ['apt', 'apt-get'].includes(keywords[index-2]) && keywords[index-1]==='purge') return `Nombre de paquete;Paquete`
            else if(keywords[index-4] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && ['pacman', 'yay', 'paru'].includes(keywords[index-2]) && ['-r', '-Rs', '-Rns', '-Rsc', '-Rdd'].includes(keywords[index-1])) return `Nombre de paquete;Paquete`
            else if(keywords[index-3] === undefined && [undefined, 'sudo'].includes(keywords[index-3]) && ['pacman', 'yay', 'paru'].includes(keywords[index-2],) && ['-R', '-Rs', '-Rns', '-Rsc', '-Rdd'].includes(keywords[index-1])) return 'Nombre de paquete;Paquete'
